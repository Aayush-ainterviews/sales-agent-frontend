...
// `onDownload` turns file-path inline code into a download action; `onSheet` adds a
// "Google Sheet" export action for .json paths.
                ...
                <span className="inline-flex items-center gap-1 align-baseline">
                  ...
                  {onSheet && /\.json$/i.test(text) && (
                    <button
                      ...
                      className="inline-flex items-center px-1 py-0.5 rounded border border-border text-green-700 dark:text-green-500 hover:opacity-70"
                    >
